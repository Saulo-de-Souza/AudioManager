@tool
@icon("res://addons/audio_manager/icons/icon_plus_2d.svg")

## AudioStreamPlus2D is a super node based on Godot's native AudioStreamPlayer2D node with improvements.
class_name AudioStreamPlus2D extends Node2D

 
#region EXPORTS ************************************************************************************
## The AudioStream resource to be played. Setting this property stops all currently playing sounds. If left empty, the AudioStreamPlayer2D does not work.
...
func get_audio_stream_player() -> AudioStreamPlayer2D:
...
func _create_audio_stream_player() -> AudioStreamPlayer2D:
	...
	new_audio_stream_player.attenuation = attenuation
